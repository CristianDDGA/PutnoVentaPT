    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SaleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    CustomerDocument = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "N/A"),
                    CustomerName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false, defaultValue: "N/A"),
                    ...
                    SellerName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "City", "DocumentNumber", "Email", "FirstName", "IsActive", "LastModifiedAt", "LastModifiedBy", "LastName", "Phone" },
                values: new object[,]
                {
                    { 1, "Av. Cevallos y Espejo", "Ambato", "1850123456", "juan.perez@gmail.com", "Juan", true, null, null, "Pérez", "0999999991" },
                    { 2, "Av. de los Shyris", "Quito", "1720123456", "maria.lopez@gmail.com", "María", true, null, null, "López", "0999999992" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "IsActive", "LastModifiedAt", "LastModifiedBy", "Name", "Price", "Stock" },
                values: new object[,]
                {
                    { 1, true, null, null, "Teclado 1", 1.50m, 50 },
                    { 2, true, null, null, "Proyecto Epson", 0.80m, 100 },
                    { 3, true, null, null, "Laptop HP ", 1.20m, 30 }
                });
